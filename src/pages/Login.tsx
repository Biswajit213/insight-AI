...
import { z } from 'zod';
import { Eye, EyeOff, Sparkles, TrendingUp, Users, Shield, Loader2 } from 'lucide-react';
    ...
    <div className="min-h-screen flex bg-[#0b1120] text-slate-100 font-sans">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#0f172a] flex-col justify-between p-12 relative overflow-hidden border-r border-slate-800">
        ...
        <div className="relative space-y-4">
          ...
          >
            The AI-powered data analytics platform that cleans raw datasets, detects anomalies,
            forecasts metrics, and answers natural language questions.
          </motion.p>
